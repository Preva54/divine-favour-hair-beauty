...
export const PERMISSION_GROUPS: { title: string; permissions: Permission[] }[] = [
  ...
  { title: "Payments", permissions: [PERMISSIONS.PAYMENTS_VIEW, PERMISSIONS.PAYMENTS_MANAGE] },
...
export const DEFAULT_ROLE_PERMISSIONS: Record<Role, readonly string[]> = {
  ...
  [Role.ACCOUNTANT]: ["dashboard:view", "bookings:view", "orders:view", "products:view", "payments:view", "payments:manage", "customers:view"],
