...
const stylistDefs = [
  { name: "Thandi Mokoena", title: "Master Hair Stylist", years: 12, rating: 5.0, reviews: 214, image: "stylist-1.jpg", featured: true, bio: "Thandi is our creative director with over a decade of mastery in cut, colour and styling. She has styled hair for runway shows, celebrities and brides across South Africa.", specialties: ["Balayage", "Silk Press", "Hair Extensions", "Wig Installation"], services: ["blow-dry", "silk-press", "hair-extensions", "balayage", "wig-installation", "hair-cut"] },
  { name: "Amara Ndlovu", title: "Senior Colour Specialist", years: 9, rating: 4.9, reviews: 168, image: "stylist-2.jpg", featured: true, bio: "Known for her artistic, damage-free colour work, Amara has a gift for finding the shade that makes every client glow.", specialties: ["Hair Colour", "Balayage", "Highlights", "Brazilian Treatment"], services: ["hair-colour", "balayage", "highlights", "brazilian-treatment"] },
  { name: "Lindiwe Khumalo", title: "Braiding & Natural Hair Expert", years: 10, rating: 5.0, reviews: 243, image: "stylist-3.jpg", featured: true, bio: "Lindiwe's braids are famous for their neatness and longevity. She is passionate about healthy natural hair for every age.", specialties: ["Braiding", "Cornrows", "Kids Hair", "Hair Treatment"], services: ["braiding", "cornrows", "kids-hair", "hair-treatment", "hair-washing"] },
  { name: "Zanele Dlamini", title: "Bridal & Makeup Artist", years: 8, rating: 4.9, reviews: 132, image: "stylist-4.jpg", featured: true, bio: "Zanele creates timeless bridal looks that photograph beautifully and last from first look to last dance.", specialties: ["Bridal Makeup", "Professional Makeup", "Eyelashes", "Eyebrow Tinting"], services: ["bridal-makeup", "professional-makeup", "eyelashes", "eyebrow-tinting"] },
  { name: "Naledi Mahlangu", title: "Nail Technician & Artist", years: 6, rating: 4.8, reviews: 156, image: "stylist-5.jpg", featured: false, bio: "From classic French tips to elaborate 3D art, Naledi's precision and creativity make her the queen of nails.", specialties: ["Acrylic Nails", "Gel Nails", "Nail Art", "Spa Pedicure"], services: ["gel-nails", "acrylic-nails", "nail-art", "french-tips", "spa-pedicure", "manicure", "pedicure"] },
  { name: "Priya Naidoo", title: "Skin & Body Therapist", years: 7, rating: 4.9, reviews: 121, image: "stylist-6.jpg", featured: false, bio: "Priya blends clinical knowledge with a healing touch, crafting personalised skincare and relaxation rituals.", specialties: ["Facials", "Body Treatments", "Massage", "Skin Care"], services: ["facials", "body-treatments", "massage", "skin-care", "waxing"] },
  { name: "Lerato Molefe", title: "Wig & Extension Specialist", years: 5, rating: 4.8, reviews: 98, image: "stylist-7.jpg", featured: false, bio: "Lerato installs and revamps wigs with an invisible, flawless finish — your hair, but better.", specialties: ["Wig Installation", "Wig Revamp", "Hair Extensions", "Braiding"], services: ["wig-installation", "wig-revamp", "hair-extensions", "braiding"] },
  { name: "Sipho Mthembu", title: "Men's Grooming & Barbering", years: 6, rating: 4.9, reviews: 187, image: "stylist-8.jpg", featured: false, bio: "Sipho delivers sharp, modern cuts and beard work with old-school precision and new-school style.", specialties: ["Men's Grooming", "Hair Cut", "Fades", "Beard Shaping"], services: ["mens-grooming", "hair-cut", "hair-washing"] },
];

const productDefs = [
  { name: "Argan Luxe Hair Oil", slug: "argan-luxe-hair-oil", category: ProductCategory.HAIR_OILS, price: 320, image: "product-1.jpg", stock: 42, rating: 4.9, reviews: 87, featured: true, desc: "100% pure Moroccan argan oil that tames frizz, adds shine and repairs split ends." },
  { name: "Rose Gold Repairing Shampoo", slug: "rose-gold-repairing-shampoo", category: ProductCategory.SHAMPOO, price: 240, image: "product-5.jpg", stock: 35, rating: 4.8, reviews: 64, featured: true, desc: "Sulphate-free shampoo infused with rose gold minerals to strengthen and restore." },
  { name: "Silk Protein Conditioner", slug: "silk-protein-conditioner", category: ProductCategory.CONDITIONERS, price: 260, image: "product-3.jpg", stock: 38, rating: 4.7, reviews: 52, desc: "Silky-smooth detangling conditioner with silk proteins and vitamin E." },
  { name: "Divine Favour Hair Mask", slug: "divine-favour-hair-mask", category: ProductCategory.HAIR_PRODUCTS, price: 380, image: "product-2.jpg", stock: 25, rating: 4.9, reviews: 71, featured: true, desc: "Weekly deep-repair treatment that restores hydration, elasticity and gloss." },
  { name: "Brazilian Keratin Treatment Kit", slug: "brazilian-keratin-treatment-kit", category: ProductCategory.HAIR_PRODUCTS, price: 550, image: "product-11.jpg", stock: 18, rating: 4.8, reviews: 44, desc: "Professional at-home smoothing kit for sleek, frizz-free hair up to 3 months." },
  { name: "Heat Protectant Spray", slug: "heat-protectant-spray", category: ProductCategory.HAIR_PRODUCTS, price: 230, image: "product-1.jpg", stock: 60, rating: 4.7, reviews: 39, desc: "Weightless thermal shield for heat styling up to 230°C, with a silk finish." },
  { name: "100% Human Hair Weave 16\"", slug: "human-hair-weave-16", category: ProductCategory.HAIR_EXTENSIONS, price: 1800, compareAtPrice: 2200, image: "product-8.jpg", stock: 12, rating: 4.9, reviews: 33, featured: true, desc: "Virgin remy human hair, ethically sourced, tangle-free and colour-treatable." },
  { name: "Lace Front Wig", slug: "lace-front-wig", category: ProductCategory.WIGS, price: 3500, compareAtPrice: 4200, image: "hair-2.jpg", stock: 8, rating: 5.0, reviews: 26, featured: true, desc: "Pre-plucked 13x4 HD lace front wig with baby hairs, natural hairline and 180% density." },
  { name: "Velvet Matte Foundation", slug: "velvet-matte-foundation", category: ProductCategory.MAKEUP, price: 420, image: "product-6.jpg", stock: 30, rating: 4.6, reviews: 58, desc: "Full-coverage, long-wear foundation in 24 inclusive shades with a soft-matte finish." },
  { name: "Rose Gold Eyeshadow Palette", slug: "rose-gold-eyeshadow-palette", category: ProductCategory.MAKEUP, price: 650, image: "product-9.jpg", stock: 20, rating: 4.8, reviews: 47, featured: true, desc: "18 buttery neutral and rose-gold shades, highly pigmented and blendable." },
  { name: "Longwear Liquid Lipstick", slug: "longwear-liquid-lipstick", category: ProductCategory.MAKEUP, price: 280, image: "product-10.jpg", stock: 45, rating: 4.7, reviews: 39, desc: "Transfer-proof, kiss-proof liquid lipstick that lasts up to 12 hours." },
  { name: "Vitamin C Brightening Serum", slug: "vitamin-c-brightening-serum", category: ProductCategory.SKINCARE, price: 460, image: "product-4.jpg", stock: 28, rating: 4.9, reviews: 93, featured: true, desc: "15% stabilised vitamin C serum for radiant, even-toned, glowing skin." },
  { name: "Rose Water Facial Mist", slug: "rose-water-facial-mist", category: ProductCategory.SKINCARE, price: 190, image: "product-2.jpg", stock: 50, rating: 4.6, reviews: 41, desc: "Hydrating, refreshing rose mist for a dewy glow — perfect over makeup." },
  { name: "Hyaluronic Moisturiser", slug: "hyaluronic-moisturiser", category: ProductCategory.SKINCARE, price: 390, image: "product-5.jpg", stock: 32, rating: 4.8, reviews: 66, desc: "Intense 24-hour hydration with hyaluronic acid, ceramides and squalane." },
  { name: "Nail Care Gift Set", slug: "nail-care-gift-set", category: ProductCategory.ACCESSORIES, price: 480, image: "nails-2.jpg", stock: 15, rating: 4.7, reviews: 28, desc: "The perfect at-home manicure kit: files, cuticle oil, base and top coat." },
  { name: "Silk Scrunchie Trio", slug: "silk-scrunchie-trio", category: ProductCategory.ACCESSORIES, price: 150, image: "product-9.jpg", stock: 70, rating: 4.8, reviews: 57, desc: "Gentle on hair, no creases — pure silk scrunchies in rose, blush and ivory." },
  { name: "Detangling Wide-Tooth Comb", slug: "detangling-wide-tooth-comb", category: ProductCategory.ACCESSORIES, price: 120, image: "hair-3.jpg", stock: 80, rating: 4.5, reviews: 22, desc: "Smooth, snag-free wide-tooth comb ideal for wet and natural hair." },
];
...
const reviewDefs = [
  ...
  { authorName: "Jessica Adams", rating: 5, text: "From the welcome tea to the final reveal, everything is luxury. My silk press lasted 3 weeks. Unreal.", featured: false },
  { authorName: "Lerato Mashego", rating: 5, text: "My wig install by Lerato looks so natural my own mother couldn't tell. 10/10!", featured: true },
  { authorName: "Sipho Khumalo", rating: 5, text: "Finally a barber that gets it right every time. Sharp fade, beard on point. Booking ahead is a must.", featured: false },
];
    ...
    data: {
      ...
      notifications: {
        create: [
          ...
          { type: "APPOINTMENT", title: "Booking confirmed", message: "Your balayage appointment with Amara is confirmed for your chosen date." },
        ],
      },
      loyaltyTransactions: {
        create: [
